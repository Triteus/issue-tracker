...
exports.basicValidators = [
    ...
    express_validator_1.body('status').optional().isIn(project_model_1.projectStatusArr),
    express_validator_1.body('type').optional().isIn(project_model_1.projectTypeArr)
];
